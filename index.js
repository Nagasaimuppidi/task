...
function playGame(playerChoices){
    ...
    if(playerChoices === computerChoices){
        ...
        switch(playerChoices){
            case "rock": result = (computerChoices === "scissors") ? "YOU WIN!" : "YOU LOSE!";
            break;
            case "paper": result = (computerChoices === "rock") ? "YOU WIN!" : "YOU LOSE!";
            break;
            case "scissors": result = (computerChoices === "paper") ? "YOU WIN!" : "YOU LOSE!";
            break;
        }
    }
    ...
    switch(result){
        ...
        break;
        case "IT'S A TIE!":resultDisplay.classList.add("yellowText");
        break;
    }
}